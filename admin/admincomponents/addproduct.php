                ...
                <div class="row1">
                    ...
                    <div class="row1_2">
                        ...
                        <textarea id="productCategoryInput" name="productCategoryInput" maxlength="1000"
                            onfocus="clearDefaultValue(this)" onblur="restoreDefaultValue(this)">Product Category:</textarea>
                        ...
                        <textarea id="productSizeInput" name="productSizeInput" maxlength="1000"
                            onfocus="clearDefaultValue(this)" onblur="restoreDefaultValue(this)">Size / Weight:</textarea>
